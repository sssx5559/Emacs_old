...
(defun arrange-strings (args &optional prompt unstrings)
  "Arrange a list of strings"

  (with-working-buffer
    (get-buffer-create arrange-buffer-name)
  
    (arrange-do-work args prompt unstrings)))

(defun arrange-strings-other-window (args &optional prompt unstrings)
...
(defun arrange-strings-other-frame (args &optional prompt unstrings)
...
;; Entry points for arranging symbols.

(defun arrange-syms (syms &optional prompt unstrings)
...
(defun arrange-syms-other-window (syms &optional prompt unstrings)
...
(defun arrange-syms-other-frame (syms &optional prompt unstrings)
  "Arrange a list of symbols in the other frame."
